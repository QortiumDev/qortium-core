...
- `Planning note` [Previewnet node minting reward bundles](design/node-minting-reward-bundles.md) - consensus-visible grouping of one Core instance's minting keys into one reward allocation
...
- `Developer reference` [QDN encrypted data envelope](qdn/encrypted-data-envelope.md) - strict QENC v2 private-chat attachment format plus v1/legacy compatibility
...
- `Upstream reference` [Qortal 6.1.8 comparison](upstream/qortal-6.1.8-comparison.md) - parser-hardening follow-up integration notes
