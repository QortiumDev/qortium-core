...
public class MaxMapEntriesPerAtUpdateRequest {
	...
	@Schema(description = "block height from which the approved limit becomes active", example = "75000")
	public int activationHeight;

	@Schema(description = "new maximum live map entries per AT; cannot be lower than the prior effective limit", example = "1000")
	...
	public MaxMapEntriesPerAtUpdateRequest() {
	}
}
