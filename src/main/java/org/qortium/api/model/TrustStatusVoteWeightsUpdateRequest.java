...
public class TrustStatusVoteWeightsUpdateRequest {
	...
	@Schema(description = "block height from which the approved trust status vote weights become active", example = "10000")
	public int activationHeight;

	@ArraySchema(schema = @Schema(description = "vote-weight percent for one trust status, ordered as SUSPICIOUS, UNVERIFIED, BRONZE, SILVER, GOLD", type = "integer"))
	public int[] weights;
	...
	public TrustStatusVoteWeightsUpdateRequest() {
	}
