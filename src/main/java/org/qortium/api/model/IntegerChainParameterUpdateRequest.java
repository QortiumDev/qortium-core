...
public class IntegerChainParameterUpdateRequest {
	...
	@Schema(description = "block height from which the approved integer value becomes active", example = "10000")
	public int activationHeight;

	@Schema(description = "new integer value", example = "30")
	public int value;
	...
	public IntegerChainParameterUpdateRequest() {
	}
