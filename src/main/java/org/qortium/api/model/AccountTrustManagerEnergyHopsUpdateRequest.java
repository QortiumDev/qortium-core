...
public class AccountTrustManagerEnergyHopsUpdateRequest {
	...
	@Schema(description = "block height from which the approved manager energy hops value becomes active", example = "10000")
	public int activationHeight;

	@Schema(description = "number of manager-rating propagation hops used during account trust derivation", example = "4")
	...
	public AccountTrustManagerEnergyHopsUpdateRequest() {
	}
