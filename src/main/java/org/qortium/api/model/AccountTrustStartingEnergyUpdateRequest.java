...
public class AccountTrustStartingEnergyUpdateRequest {
	...
	@Schema(description = "block height from which the approved starting energy becomes active", example = "10000")
	public int activationHeight;

	@Schema(description = "starting energy distributed across minting-group seed accounts during account trust derivation", example = "1000000")
	...
	public AccountTrustStartingEnergyUpdateRequest() {
	}
