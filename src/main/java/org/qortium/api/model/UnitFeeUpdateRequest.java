...
public class UnitFeeUpdateRequest {
	...
	@Schema(description = "block height from which the approved unit fee becomes active", example = "10000")
	public int activationHeight;

	@Schema(description = "new normal transaction unit fee", example = "0.01000000", type = "number")
