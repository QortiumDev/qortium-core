...
public class AccountTrustSuspiciousMinRatingConfidenceUpdateRequest {
	...
	@Schema(description = "block height from which the approved suspicious rating confidence becomes active", example = "10000")
	public int activationHeight;

	@Schema(description = "minimum negative rating confidence required to count toward suspicious account trust levels", example = "2")
	...
	public AccountTrustSuspiciousMinRatingConfidenceUpdateRequest() {
	}
