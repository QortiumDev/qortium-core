...
import org.qortium.notification.ResourcePublishedEvent;
...
public class ArbitraryTransaction extends Transaction {
	...
	public ValidationResult isFeeValid() throws DataException {
		...
		// ARBITRARY transactions can either pay the normal fee or use MemoryPoW when fee is zero.
		if (this.arbitraryTransactionData.getFee() != 0L)
