 ...
 * <p>
 * <ul>
 * <li>Bob generates Digibyte & local-chain 'trade' keys
 * 		<ul>
 ...
 * 		<ul>
 * 			<li>Alice generates Digibyte & local-chain 'trade' keys</li>
...
public class DigibyteACCTv3 implements ACCT {
	 ...
	 */
	public static byte[] buildTradeAT(String creatorTradeAddress, byte[] digibytePublicKeyHash, long nativeAmount, long digibyteAmount, int tradeTimeout) {
		...
		for (int pass = 0; pass < 2; ++pass) {
			...
			try {
				...
				codeByteBuffer.put(OpCode.EXT_FUN_DAT.compile(ChainFunctionCode.PUT_PARTIAL_MESSAGE_FROM_TX_IN_A_INTO_B.value, addrTradeMessagePartnerDigibytePKHOffset));
				...
				throw new IllegalStateException("Unable to compile DGB-NATIVE ACCT?", e);
			}
		}
