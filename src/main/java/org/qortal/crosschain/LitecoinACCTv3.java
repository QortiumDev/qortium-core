 ...
 * <p>
 * <ul>
 * <li>Bob generates Litecoin & local-chain 'trade' keys
 * 		<ul>
 ...
 * 		<ul>
 * 			<li>Alice generates Litecoin & local-chain 'trade' keys</li>
...
public class LitecoinACCTv3 implements ACCT {
	 ...
	 */
	public static byte[] buildTradeAT(String creatorTradeAddress, byte[] litecoinPublicKeyHash, long nativeAmount, long litecoinAmount, int tradeTimeout) {
		...
		for (int pass = 0; pass < 2; ++pass) {
			...
			try {
				...
				codeByteBuffer.put(OpCode.EXT_FUN_DAT.compile(ChainFunctionCode.PUT_PARTIAL_MESSAGE_FROM_TX_IN_A_INTO_B.value, addrTradeMessagePartnerLitecoinPKHOffset));
				...
				throw new IllegalStateException("Unable to compile LTC-NATIVE ACCT?", e);
			}
		}
