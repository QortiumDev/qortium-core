 ...
 * <p>
 * <ul>
 * <li>Bob generates Ravencoin & local-chain 'trade' keys
 * 		<ul>
 ...
 * 		<ul>
 * 			<li>Alice generates Ravencoin & local-chain 'trade' keys</li>
...
public class RavencoinACCTv3 implements ACCT {
	 ...
	 */
	public static byte[] buildTradeAT(String creatorTradeAddress, byte[] ravencoinPublicKeyHash, long nativeAmount, long ravencoinAmount, int tradeTimeout) {
		...
		for (int pass = 0; pass < 2; ++pass) {
			...
			try {
				...
				throw new IllegalStateException("Unable to compile RVN-NATIVE ACCT?", e);
			}
		}
