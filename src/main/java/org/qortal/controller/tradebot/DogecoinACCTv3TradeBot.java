...
public class DogecoinACCTv3TradeBot implements AcctTradeBot {
	...
	/**
	 * Creates a new trade-bot entry from the "Bob" viewpoint, i.e. OFFERing NATIVE in exchange for DOGE.
	 * <p>
	 * Generates:
	 * <ul>
	...
	public byte[] createTrade(Repository repository, TradeBotCreateRequest tradeBotCreateRequest) throws DataException {
		...
		String name = "NATIVE/DOGE ACCT";
		String description = "NATIVE/DOGE cross-chain trade";
		String aTType = "ACCT";
		String tags = "ACCT NATIVE DOGE";
		byte[] creationBytes = DogecoinACCTv3.buildTradeAT(tradeNativeAddress, tradeForeignPublicKeyHash, tradeBotCreateRequest.nativeAmount,
	...
	private void handleAliceWaitingForAtLock(Repository repository, TradeBotData tradeBotData,
		...
		byte[] messageData = DogecoinACCTv3.buildRedeemMessage(secretA, receivingAddress);
		String messageRecipient = tradeBotData.getAtAddress();
	...
	private void handleBobWaitingForAtRedeem(Repository repository, TradeBotData tradeBotData,
		...
		if (crossChainTradeData.mode == AcctMode.REFUNDED || crossChainTradeData.mode == AcctMode.CANCELLED) {
			// Alice hasn't redeemed the native asset, so there is no point in trying to redeem the DOGE
			TradeBot.updateTradeBotState(repository, tradeBotData, State.BOB_REFUNDED,
