...
public class LitecoinACCTv3TradeBot implements AcctTradeBot {
	...
	/**
	 * Creates a new trade-bot entry from the "Bob" viewpoint, i.e. OFFERing NATIVE in exchange for LTC.
	 * <p>
	 * Generates:
	 * <ul>
	...
	public byte[] createTrade(Repository repository, TradeBotCreateRequest tradeBotCreateRequest) throws DataException {
		...
		String name = "NATIVE/LTC ACCT";
		String description = "NATIVE/LTC cross-chain trade";
		String aTType = "ACCT";
		String tags = "ACCT NATIVE LTC";
		byte[] creationBytes = LitecoinACCTv3.buildTradeAT(tradeNativeAddress, tradeForeignPublicKeyHash, tradeBotCreateRequest.nativeAmount,
	...
	private void handleAliceWaitingForAtLock(Repository repository, TradeBotData tradeBotData,
		...
		byte[] messageData = LitecoinACCTv3.buildRedeemMessage(secretA, receivingAddress);
		String messageRecipient = tradeBotData.getAtAddress();
	...
	private void handleBobWaitingForAtRedeem(Repository repository, TradeBotData tradeBotData,
		...
		if (crossChainTradeData.mode == AcctMode.REFUNDED || crossChainTradeData.mode == AcctMode.CANCELLED) {
			// Alice hasn't redeemed the native asset, so there is no point in trying to redeem the LTC
			TradeBot.updateTradeBotState(repository, tradeBotData, State.BOB_REFUNDED,
