...
public class AccountTrustSuspiciousMinRaterCountUpdateRequest {
	...
	@Schema(description = "block height from which the approved suspicious rater count becomes active", example = "10000")
	public int activationHeight;

	@Schema(description = "minimum number of independent negative raters required for suspicious account trust levels", example = "2")
	...
	public AccountTrustSuspiciousMinRaterCountUpdateRequest() {
	}
