...
def run_check(
    ...
    print()
    print("Next steps:")
    print("  1. Review the official PirateNetwork/Stashi-Wallet release")
    print(f"     ({upstream_version.raw}) and download its signed JNI artifact bundle.")
    print("     Check the actual asset filename; it may differ from the release tag.")
    print("  2. Verify upstream signatures with the trusted upstream signing key")
    print("     and verify the bundle's SHA-256 against the signed checksum.")
    print("  3. Stage the verified artifact and run Core compatibility and acceptance")
    print("     (see docs/cross-chain/pirate-unified-wallet-acceptance.md).")
    print("  4. Republish the staged official bytes to QDN when authorized,")
    print("     and byte-verify the served bundle matches the verified upstream asset.")
    print("  5. Repin RELEASE_TAG, ARTIFACT_FILENAME and size, the SHA-256 in")
    ...
    print("     deferred).")
    print("  Fork builds are compatibility proof only; use official upstream bytes")
    print("  for the shipped QDN bundle.")
